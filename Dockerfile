FROM ubuntu:23.04
RUN apt-key adv --keyserver keyserver.ubuntu.com --recv-keys 871920D1991BC93C && apt update && apt-get install -y build-essential && apt-get install -y zip && apt-get install wget -y
